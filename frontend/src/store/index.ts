...
import dailyRouteReducer from "./dailyRouteSlice"
...
const persistConfig = {
  key: 'root',
  storage,
  whitelist: ['scenarios', 'companyInfo', 'enrichedAppointments', 'excludedAppointments', 'dailyRoute'],
};
